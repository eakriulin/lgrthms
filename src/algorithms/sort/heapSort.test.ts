...
describe('heapSort', () => {
    test('heapSort | random array, sort asc => sorted array', () => {
        const min = 5;
        const max = 100;
        ...
        heapSort(numbers, (a, b) => a - b);
        heapSort(strings);
        heapSort(objects, (a, b) => a.value - b.value);
    ...
    test('heapSort | random array, sort desc => sorted array', () => {
        const min = 5;
        const max = 100;
        const length = Math.floor(Math.random() * (max - min + 1)) + min;
        ...
        heapSort(numbers, (a, b) => b - a);
        heapSort(strings, (a, b) => b.localeCompare(a));
        heapSort(objects, (a, b) => b.value - a.value);
