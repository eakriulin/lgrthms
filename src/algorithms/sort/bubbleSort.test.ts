...
describe('bubbleSort', () => {
    test('bubbleSort | random array, sort asc => sorted array', () => {
        const min = 5;
        const max = 100;
        ...
        bubbleSort(strings);
        bubbleSort(objects, (a, b) => a.value - b.value);
    ...
    test('bubbleSort | random array, sort desc => sorted array', () => {
        const min = 5;
        const max = 100;
        const length = Math.floor(Math.random() * (max - min + 1)) + min;
        ...
        bubbleSort(strings, (a, b) => b.localeCompare(a));
        bubbleSort(objects, (a, b) => b.value - a.value);
