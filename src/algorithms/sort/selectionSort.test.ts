...
describe('selectionSort', () => {
    test('selectionSort | random array, sort asc => sorted array', () => {
        const min = 5;
        const max = 100;
        ...
        selectionSort(objects, (a, b) => a.value - b.value);
    ...
    test('selectionSort | random array, sort desc => sorted array', () => {
        const min = 5;
        const max = 100;
        const length = Math.floor(Math.random() * (max - min + 1)) + min;
        ...
        selectionSort(strings, (a, b) => b.localeCompare(a));
        selectionSort(objects, (a, b) => b.value - a.value);
